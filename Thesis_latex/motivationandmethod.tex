...
\tcr{describe more the number of subset you want to have in this example. I think it is 3 in x and 4 in y. Also, introduce the notion of cut lines/cut planes here. it seems like it is a good place to do that}
...
\tcr{it would be useful to add two short paragraphs that give the essence of the algorithms rather than having the reader try to determine this on their own}
