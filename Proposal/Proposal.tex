...
While the problem is not balanced, we check if the cells per row and cells per column metrics, $f_I$ and $f_J$, are balanced. If they are not, we redistribute the cut lines. 
