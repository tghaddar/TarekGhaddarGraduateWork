...
\tcr{simpler introduction sweep: solve on a cell-by-cell basis}

A \tcr{parallel} sweep algorithm is defined by three properties:
\begin{itemize}
...
\begin{itemize}
\item Unstructured meshing capability in PDT.\tcr{2D + 2D extruded}
\item {Parallel meshing: ...}
\item {Stitching between meshed subdomains}
%\end{itemize}

%\subsection{Planned Work}
%\begin{itemize}
\item Implement load balancing algorithm for unstructured meshes in PDT. \tcr{Metric definition}
\item Code verification, testing
\item Parallel sweep results 
\end{itemize}
