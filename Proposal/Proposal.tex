...
\section{Time to Solution Estimation}
...
\label{num_z}
\end{align}
Given that we know the number of mesh cells in the entire domain, this information is combined with the partitioning information to obtain the crucial cells per subset and boundary cells per subset variables. 
