...
z_cuts,x_cut_suite,y_cut_suite = create_opt_cut_suite_3d(points,gxmin,gxmax,gymin,gymax,gzmin,gzmax,numcol,numrow,numplane)
...
np.savetxt("max_times_im1_best",max_times)
