...
For the load balanced and load-balanced-by-dimension cases, we see a similar increasing trend for $f$, although it is not quite as consistent for hte load-balance-by-dimension cases. 
This is lack of consistency can be attributed to $y$ cut lines not going all the way through the mess, and adding cells in a less consistent way throughout the mesh. 
...
The original load balancing and load-balancing-by-dimension algorithms allowed 
