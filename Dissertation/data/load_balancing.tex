...
\end{itemize}
Using cut lines/cut planes to partition unstructured meshes preserved\jcr{? and I would not put it in the present either. maybe may preserve but you need to explain the conditions under which something like this can be achieved.... this is missing} the provably optimal sweep partitioning \cite{mpadams2013,mpadams2015} of logically Cartesian grids.
