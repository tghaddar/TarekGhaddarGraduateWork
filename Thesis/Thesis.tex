...
In order to showcase the behavior of the load balancing metric, three test cases are presented. Figure \ref{opp} shows the first test case, a large domain with two pins in opposite corners of the domain. This is theoretically a very unbalanced case, 
...
\noindent\begin{minipage}{\textwidth}
\centering
\includegraphics[scale=0.75]{OppNoIter.pdf}
...
\noindent\begin{minipage}{\textwidth}
\centering
\includegraphics[scale=0.75]{OppIter.pdf}
...
\noindent\begin{minipage}{\textwidth}
\centering
\includegraphics[scale=0.75]{OppDiff.pdf}
...
\noindent\begin{minipage}{\textwidth}
\centering
\includegraphics[scale=0.75]{SameNoIter.pdf}
...
\noindent\begin{minipage}{\textwidth}
\centering
\includegraphics[scale=0.75]{SameIter.pdf}
...
\noindent\begin{minipage}{\textwidth}
\centering
\includegraphics[scale=0.75]{SameDiff.pdf}
