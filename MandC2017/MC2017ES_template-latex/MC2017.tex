...
\email{tghaddar@tamu.edu \and jean.ragusa@tamu.com}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.22]{figures/UnstructureMesh.pdf}
\includegraphics[scale = 0.22]{figures/StructuredMesh.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.35,trim = 0cm 3.5cm 0cm 3cm,clip]{figures/tdg.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.73]{figures/Partitioning.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.06,trim = 10cm 10cm 0cm 0cm ]{figures/solutionmesh.png}
...
\subsubsection{The 1D Pure Absorber Slab}
...
For an optically thick, source free 1D pure scatterer with monoenergetic neutrons, the transport solution will reach the diffusion limit. The diffusion equation for this problem is represented by Eq. ~\eqref{diffusion}:
%Scattering equation
\begin{equation}
\frac{d^2\phi}{dx^2} = 0,
\label{diffusion}
