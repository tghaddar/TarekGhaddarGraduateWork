...
\begin{block}{}
\begin{itemize}
\item There are conflicts at Node 0 or Node 2. The fastest paths finish by the time the slower paths arrive.
...
\item Path 1 is still solving Node 1 when Path 3 arrives. Delay of $48345-40292$ is added.
\item Path 2 starts solving Node 3 at t=40929. Path 1 is delayed a further 40929 (Node 3's solve time). 
\item Path 0 can solve Node 3 at t=48345. Path 2 is not finished solving until t=81858. Delay of $8185-48345=33513$ added.
\end{itemize}
\end{block}
\end{frame}
