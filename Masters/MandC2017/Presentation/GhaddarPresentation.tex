...
\title[Load Balancing]{An Approach for Load Balancing Massively Parallel Transport Sweeps on Unstructured Grids}
\author[Ghaddar]{Tarek Habib Ghaddar \\  Dr. Jean Ragusa}
...
\begin{frame}[t]\frametitle{f = 2.633}
\centering
\includegraphics[scale=0.33]{figures/IM1_old_load_balance.png}
\end{frame}

\begin{frame}[t]\frametitle{f = 1.762}
\centering
